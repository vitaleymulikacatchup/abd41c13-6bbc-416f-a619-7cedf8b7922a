...
export const metadata: Metadata = {
  title: "SaaS Pro - Business Automation & Analytics Platform",
  description: "Empower your team with intelligent automation, real-time analytics, and seamless collaboration. Start free today.",
  keywords: "SaaS, business automation, analytics platform, team collaboration, workflow automation",
  metadataBase: new URL("https://saaspro.io"),
  alternates: {
    canonical: "https://saaspro.io"
  },
  openGraph: {
    title: "SaaS Pro - Business Automation & Analytics",
    description: "Transform how your team works with powerful automation and real-time insights.",
    url: "https://saaspro.io",
    siteName: "SaaS Pro",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763823858730-ewvov9uo.jpg",
        alt: "SaaS Pro Dashboard Interface"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "SaaS Pro - Business Automation Platform",
    description: "Automate workflows and gain insights. 50,000+ users trust SaaS Pro.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763823858730-ewvov9uo.jpg"]
  },
  robots: {
    index: true,
    follow: true
